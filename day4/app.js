    ...
    const inventors = [
      ...
      let borninFifteenHundreds = inventors.filter(function(inventors) {
        return inventors.year > 1499 && inventors.year < 1600;
      });
      ...
      let newArray = inventors.map((inventor) => inventor.first + " " + inventor.last);
      console.log(newArray);
      // Array.prototype.sort()
      // 3. Sort the inventors by birthdate, oldest to youngest
      let inventorYears = inventors.sort((a, b) => a.year - b.year);
